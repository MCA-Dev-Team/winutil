...
function Get-LatestRelease {
    try {
        $releases = Invoke-RestMethod -Uri 'https://api.github.com/repos/mca-dev-team/winutil/releases'
...
function RedirectToLatestPreRelease {
    ...
    if ($latestRelease) {
        $url = "https://github.com/mca-dev-team/winutil/releases/download/$latestRelease/winutil.ps1"
    } else {
        ...
        $url = "https://github.com/mca-dev-team/winutil/releases/latest/download/winutil.ps1"
    }
